...
Attempted to fit an lme() model with '*episodes*' between feedings as random effects (intercept or slope+intercepts with time since last feeding). The results were less than persuasive.
...
Model diagnostics are acceptable which is great news.  
