...
Next steps are to determine the 'best' value for 'n'. I plan to use a rolling forecast but not with mixed models due to computatonal complexity.
...
k <- 15 # optim. by rolling forecasts
...
ggplot(dat_p[dat_p$fastd==8,], 
  ...
  scale_y_continuous(minor_breaks = seq(60,90,1), 
                     breaks = seq(60,90,5)) +
